...
const btnClass = 'flex items-center justify-center rounded-full border border-border text-fg-subtle hover:text-fg-muted hover:border-border-hover transition-colors cursor-pointer'
